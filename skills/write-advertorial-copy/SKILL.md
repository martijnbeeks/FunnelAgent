...
Read the CONFIG schema reference to understand the CONFIG structure:
```
templates/advertorial_config_schema.md
```

This contains all CONFIG keys, types, allowed HTML elements, and theme options. Do NOT read the full HTML template here — you only need the template in Step 9 for assembly.

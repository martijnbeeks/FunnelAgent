...
## By Owen Clary & Aris van Houten | Manual Revision 1/29
...
### THE BRIEF CONTAINS (DO NOT RECREATE):
...
| Element | Location |
| :---- | :---- |
| Avatar details | PART 1 of brief |
| Forced angle/mechanism | PART 2 of brief |
| Proof points | PART 3 of brief (use these \+ add supporting stats) |
| Big Ideas | PART 4 of brief |
| Stage-specific approach | PART 5 of brief |
| Transformation details | PART 6 of brief |
| Product connection | PART 7 of brief |
| Copy direction | PART 8 of brief |
| Quote library | APPENDIX of brief |
...
### A. THE FORCED ANGLE (PART 2 of Brief)
...
### B. THE ONE AVATAR (PART 1 of Brief)
...
Stage 3, 4 or Stage 5?: \[Noted in brief's Executive Summary\]
...
### E. KEY PROOF POINTS (PART 3 of Brief)

Top Study: \[Extract from Section 3.1 \- Tier 1\]

Top Expert: \[Extract from Section 3.1 \- Tier 2\]

Top Statistic: \[Extract from Section 3.1 \- Tier 3\]
...
→ "Identification Markers" (Section 1.8 of brief) for "That's Me" triggers → Quotes from "Fear Quotes" (Appendix A.1 of brief) → Follow sophistication approach (Section 8.1 or 8.2 based on stage) → "UMP" definition (Section 2.1 of brief) \- this is your enemy → "Proof Points" (Section 3.1 of brief) for studies → "Mechanism Language Bank" (Section 2.4 of brief) for terminology → Add supporting statistics to reinforce the UMP → "Failed Solutions" (Section 1.5 of brief) \- these are what they tried → "Failure Explanation Matrix" (Section 2.3 of brief) for why each failed → Exact quotes from "Failure Quotes" (Appendix A.3 of brief) → "UMS" definition (Section 7.1 of brief) \- this is your solution mechanism → "How Product Addresses Mechanism" (Section 7.1 of brief) → Supporting data and statistics to validate the UMS → "Product-Mechanism Connection" (Section 7.1 of brief) → "Ingredient-Mechanism Map" (Section 7.2 of brief) → "Transformation Timeline" (Section 6.3 of brief) for benefits/timeline → "Competitive Differentiation" (Section 7.3 of brief) → "Current State" (Section 6.1 of brief) for before state → "Future State" (Section 6.2 of brief) for after state → Exact quotes from quote banks (Sections 6.1 and 6.2) → "Pre-Purchase Objections" (Section 1.7 of brief) → "Belief System" (Section 1.6 of brief) for belief shifts needed → Reference avatar's skepticism patterns (Section 1.7 of brief) → Counter specific objections listed in brief
...
**Transition Into Section:** "But here's what people always ask me..."
...
What role were they forced into? (the sick one, the fragile one, the one who can't keep up) What labels defined them? (the grandma who needs help, the retiree who's declining) What social identity did they lose? (the active one, the capable one, the young-spirited one)
...
**Where Expert Quotes Go Instead:** Embed expert endorsements in body copy within Section 4 (Mechanism) or Section 5 (Product). Use the `<div class="quote-box">` element for prominent expert quotes.
...
**SIDEBAR\_REVIEWS:** 3 user reviews (same format as bottom reviews, displayed in sidebar)
...
THEME: "\\\[health/medical/beauty/energy/calm\\\]",
...
HEADLINE: "\\\[Section 1 Main Headline\\\]",

SUBHEADLINE: "\\\[Section 1 Subheadline \\- curiosity teaser\\\]",

AUTHOR\\\_NAME: "\\\[Narrator name matching demographics\\\]",

HERO\\\_IMAGE: "\\\[URL or empty\\\]",

// \\============ SECTIONS \\============

SECTIONS: \\\[

// SECTION 1: HOOK (Opening Lead)

{

    headline: "\\\\\\\[Hook headline \\\\- specific pain moment\\\\\\\]",

    image: "",

    body: \\\\\\\`\\\\\\\[Lead copy: yes-train, symptoms, authority, hint at solution\\\\\\\]\\\\\\\`

},

// SECTION 2: EDUCATION (UMP Reveal)

{

    headline: "\\\\\\\[UMP revelation headline with data\\\\\\\]",

    image: "\\\\\\\[URL or empty\\\\\\\]",

    body: \\\\\\\`\\\\\\\[Education copy: UMP reveal, data, validation, danger, tease\\\\\\\]\\\\\\\`

},

// SECTION 3: DISCREDIT SOLUTIONS

{

    headline: "\\\\\\\[Why nothing worked headline\\\\\\\]",

    image: "",

    body: \\\\\\\`\\\\\\\[Use \\\\\\\<p class="failed-solution"\\\\\\\> for each failed solution\\\\\\\]\\\\\\\`

},

// SECTION 4: UNIQUE MECHANISM (NO product name)

{

    headline: "\\\\\\\[Mechanism discovery headline\\\\\\\]",

    image: "\\\\\\\[URL or empty\\\\\\\]",

    body: \\\\\\\`\\\\\\\[Use \\\\\\\<div class="quote-box"\\\\\\\> and \\\\\\\<div class="mechanism-box"\\\\\\\>\\\\\\\]\\\\\\\`

},

// SECTION 5: INTRODUCE PRODUCT (Saturation begins)

{

    headline: "\\\\\\\[Product headline with PRODUCT\\\\\\\_NAME\\\\\\\]",

    image: "\\\\\\\[URL or empty\\\\\\\]",

    body: \\\\\\\`\\\\\\\[Product intro, benefits with \\\\\\\<p class="timeline-item"\\\\\\\>\\\\\\\]\\\\\\\`
...

{
    ...
    headline: "\\\\\\\[Objection handling headline\\\\\\\]",

    image: "",

    body: \\\\\\\`\\\\\\\[Q\\\\\\\&A format: 4-7 objections with confident answers\\\\\\\]\\\\\\\`
...

{
    ...
    headline: "\\\\\\\[Identity transformation headline\\\\\\\]",

    image: "\\\\\\\[URL or empty\\\\\\\]",

    body: \\\\\\\`\\\\\\\[Identity journey with \\\\\\\<div class="validation-box"\\\\\\\>\\\\\\\]\\\\\\\`

},

// SECTION 8: OFFER \\\\+ TWO PATHS

{

    headline: "\\\\\\\[Offer/choice headline\\\\\\\]",

    image: "",

    body: \\\\\\\`\\\\\\\[Risk reversal, urgency, two paths, final push\\\\\\\]\\\\\\\`
...
PRODUCT\\\_IMAGE: "\\\[URL or empty\\\]",

PRODUCT\\\_DESCRIPTION: "\\\[One sentence \\- what it is \\+ key differentiator\\\]",

PRODUCT\\\_BENEFITS: \\\[

"\\\\\\\[Benefit 1 \\\\- outcome in X days/weeks using mechanism\\\\\\\]",

"\\\\\\\[Benefit 2 \\\\- addresses primary fear\\\\\\\]",

"\\\\\\\[Benefit 3 \\\\- UMS differentiator\\\\\\\]",

"\\\\\\\[Benefit 4 \\\\- ease/convenience\\\\\\\]",

"\\\\\\\[Benefit 5 \\\\- guarantee/risk reversal\\\\\\\]"

\\\],

ORDER\\\_URL: "\\\#next-step",

// \\============ SIGN-OFF \\============

SIGN\\\_OFF\\\_TEXT: "\\\[Warm closing matching narrator voice\\\]",

SIGN\\\_OFF\\\_NAME: "—\\\[Narrator Name\\\], Age \\\[XX\\\]",

// \\============ SIDEBAR REVIEWS (User Reviews) \\============

SIDEBAR\\\_REVIEWS: \\\[

{ stars: "★★★★★", text: "\\\\\\\[Short user review 1-2 sentences\\\\\\\]", name: "\\\\\\\[Name\\\\\\\]", age: "\\\\\\\[XX\\\\\\\]", initial: "\\\\\\\[X\\\\\\\]" },

{ stars: "★★★★★", text: "\\\\\\\[Short user review with result\\\\\\\]", name: "\\\\\\\[Name\\\\\\\]", age: "\\\\\\\[XX\\\\\\\]", initial: "\\\\\\\[X\\\\\\\]" },

{ stars: "★★★★★", text: "\\\\\\\[Short user review with timeframe\\\\\\\]", name: "\\\\\\\[Name\\\\\\\]", age: "\\\\\\\[XX\\\\\\\]", initial: "\\\\\\\[X\\\\\\\]" }
...
REVIEWS\\\_COUNT: "\\\[Number only e.g. 17,482\\\]",

REVIEWS: \\\[

{ name: "\\\\\\\[Name\\\\\\\]", age: "\\\\\\\[XX\\\\\\\]", initial: "\\\\\\\[X\\\\\\\]", stars: "★★★★★", title: "\\\\\\\[Success headline\\\\\\\]", text: "\\\\\\\[Include PRODUCT\\\\\\\_NAME, specific result, timeframe\\\\\\\]" },

{ name: "\\\\\\\[Name\\\\\\\]", age: "\\\\\\\[XX\\\\\\\]", initial: "\\\\\\\[X\\\\\\\]", stars: "★★★★★", title: "\\\\\\\[Family member results\\\\\\\]", text: "\\\\\\\[Bought for someone else\\\\\\\]" },

{ name: "\\\\\\\[Name\\\\\\\]", age: "\\\\\\\[XX\\\\\\\]", initial: "\\\\\\\[X\\\\\\\]", stars: "★★★★☆", title: "\\\\\\\[Honest review\\\\\\\]", text: "\\\\\\\[4-star for authenticity\\\\\\\]" },

{ name: "\\\\\\\[Name\\\\\\\]", age: "\\\\\\\[XX\\\\\\\]", initial: "\\\\\\\[X\\\\\\\]", stars: "★★★★★", title: "\\\\\\\[Comparison to failed products\\\\\\\]", text: "\\\\\\\[PRODUCT\\\\\\\_NAME worked where others didn't\\\\\\\]" },

{ name: "\\\\\\\[Name\\\\\\\]", age: "\\\\\\\[XX\\\\\\\]", initial: "\\\\\\\[X\\\\\\\]", stars: "★★★★★", title: "\\\\\\\[Long-term results\\\\\\\]", text: "\\\\\\\[X months later, still working\\\\\\\]" },

{ name: "\\\\\\\[Name\\\\\\\]", age: "\\\\\\\[XX\\\\\\\]", initial: "\\\\\\\[X\\\\\\\]", stars: "★★★★★", title: "\\\\\\\[Skeptic who tried guarantee\\\\\\\]", text: "\\\\\\\[Almost didn't try, so glad I did\\\\\\\]" },

{ name: "\\\\\\\[Name\\\\\\\]", age: "\\\\\\\[XX\\\\\\\]", initial: "\\\\\\\[X\\\\\\\]", stars: "★★★★★", title: "\\\\\\\[Identity transformation\\\\\\\]", text: "\\\\\\\[Who they've become thanks to PRODUCT\\\\\\\_NAME\\\\\\\]" }
...
- [ ] 5 PRODUCT\_BENEFITS with timeframes  
- [ ] PRODUCT\_DESCRIPTION is one sentence

**Reviews:**

- [ ] 3 SIDEBAR\_REVIEWS (user reviews with age)  
- [ ] 7 REVIEWS (user comments)  
- [ ] At least one 4-star review  
- [ ] PRODUCT\_NAME in most reviews  
- [ ] No trademark symbols (™)  
- [ ] No hyphens or dashes

**Sign-off:**

- [ ] SIGN\_OFF\_TEXT warm and caring  
- [ ] SIGN\_OFF\_NAME matches narrator
...
After the summary, generate \*\*7 headline \+ subheadline pairs\*\*, each entering through a different psychological doorway (e.g. specific pain moment, mechanism curiosity, authority discovery, timeframe \+ outcome, failed solution contrast, social proof, identity reclaimed). Different psychology, not synonym swaps.

\*\*Rules:\*\*  
\- All existing Hook rules apply (hide mechanism, no product name, headline under 100 chars, subheadline max 150 chars)  
\- Every claim or reference teased in a headline must be substantiated in the body copy — the headline is a door into the existing story, not a different story  
\- Score each pair 1-10 on: Scroll Stop, Curiosity Gap, Avatar Resonance, Believability

\*\*Output:\*\* Score and rank all 7\. Place the \#1 scorer in the CONFIG. Output \#2 and \#3 as split-test alternatives:

// ALL 7 HEADLINES RANKED:  
// 1\. \[Doorway\] | Score: X/10 — "\[Headline\]" ← Used in CONFIG  
// 2\. \[Doorway\] | Score: X/10 — "\[Headline\]" ← Alt A  
// 3\. \[Doorway\] | Score: X/10 — "\[Headline\]"  ← Alt B  
// 4-7. \[Doorway\] | Score: X/10 — "\[Headline\]"

// SPLIT-TEST ALTERNATIVE A  
// Doorway: \[Name\] | Score: X/10  
HEADLINE: "\[Text\]",  
SUBHEADLINE: "\[Text\]",

// SPLIT-TEST ALTERNATIVE B  
// Doorway: \[Name\] | Score: X/10  
HEADLINE: "\[Text\]",  
SUBHEADLINE: "\[Text\]",

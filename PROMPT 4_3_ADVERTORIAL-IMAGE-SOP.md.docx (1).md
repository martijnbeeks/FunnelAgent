...
| **Section 7** | Offer | Product Shot | **CLEAN PRODUCT PHOTO — ⚠️ USER PROVIDES** |
...
- **Format:** 16:9 for ALL images EXCEPT Section 8 (Product Shot) which is 1:1  
- **Diagram Labels:** In TARGET LANGUAGE

---

## ⚠️ TEXT IN IMAGES — MOBILE \+ 50+ READABILITY RULES
...
## ⚠️ PRODUCT IMAGE RULE

**The user MUST provide a real product image/photo.** AI-generated product shots look fake. Sections that require actual product visuals (S5 Infographic, S8 Product Shot) depend on the user supplying a real product photo.

**When generating image prompts:** If S5 or S8 requires a product image, clearly mark it with:

**⚠️ USER ACTION REQUIRED:** Provide your actual product photo for this image. Do NOT generate the product — use the real product image supplied by the client.

**If no product image has been provided**, flag it at the top of the output:

**⚠️ MISSING INPUT: Product image not provided. S5 (Infographic) and S8 (Product Shot) cannot be completed without a real product photo. Please supply before finalising.**
...
**Tool:** Higgsfield Soul (action) or Nanobanan (portrait) | **Format:** 16:9
...
**Tool:** Nanobanan | **Format:** 1:1 ← THE ONLY 1:1 IMAGE
...
⚠️ USER ACTION REQUIRED: Use the real product image supplied by the client. Do NOT AI-generate the product.
...
\# IMAGE PROMPTS: \[PRODUCT\_NAME\] Advertorial
...
\- \*\*Product Image Provided:\*\* \[YES / NO — if NO, flag S5 and S8 as incomplete\]
...
\*\*⚠️ Requires real product image from user\*\*
...
\*\*Tool:\*\* \[Higgsfield Soul / Nanobanan\] | \*\*16:9\*\*
...
\*\*Tool:\*\* Nanobanan | \*\*1:1\*\* ← ONLY 1:1 image
...
| Section | Image Type | Format | Tool | Product Image Required? |
| :---- | :---- | :---- | :---- | :---- |
| Hero | Recognition/Transform/Aspire | 16:9 | Nano/Nano/Soul | No |
| Section 0 | Wound — Desire Denied | 16:9 | Nanobanan | No |
| Section 1 | UMP Diagram | 16:9 | Nanobanan | No |
| Section 2 | Comparison Diagram | 16:9 | Nanobanan | No |
| Section 3 | UMS Diagram | 16:9 | Nanobanan | No |
| Section 4 | Product Infographic | 16:9 | Nanobanan | **⚠️ YES** |
| Section 5 | Skip (or Expert) | 16:9 | Nanobanan | No |
| Section 6 | Transformation | 16:9 | Soul/Nanobanan | No |
| Section 7 | Clean Product Shot | **1:1** | Nanobanan | **⚠️ YES** |
...
* **⚠️ Real product image from user (required for S5 \+ S8)**
...
* Formats correct (16:9 ALL images, 1:1 ONLY for S8 product shot)  
...
* **S5 and S8 use real product image (not AI-generated)**  
* **S1 wound image targets PRIMARY DESIRE denied — not just generic pain**
